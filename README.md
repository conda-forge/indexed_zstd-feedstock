      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=18161&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/indexed_zstd-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_python3.15.____cp315" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add indexed_zstd
# for installing globally
pixi global install indexed_zstd
```
...
It is possible to list all of the versions of `indexed_zstd` available on your platform:
...
```
pixi search indexed_zstd --channel conda-forge
```
